...
namespace eTeamProjectManagement.Data.Migrations
{
    ...
    [Migration("20170203205802_secondversionofproject")]
    partial class secondversionofproject
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("eTeamProjectManagement.Entities.ProjectData", b =>
                {
                    b.HasOne("eTeamProjectManagement.Entities.ProjectPriorities", "Priority")
                        .WithMany()
                        .HasForeignKey("PriorityId");

                    b.HasOne("eTeamProjectManagement.Entities.ProjectTypes", "ProjectType")
                        .WithMany()
                        .HasForeignKey("ProjectTypeId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("eTeamProjectManagement.Entities.ProjectStatuses", "Status")
                        .WithMany()
            ...
            modelBuilder.Entity("eTeamProjectManagement.Entities.ProjectITUpdate", b =>
                {
                    b.HasOne("eTeamProjectManagement.Entities.ProjectUpdatePartys", "UpdateFrom")
                        .WithMany()
                        .HasForeignKey("UpdateFromId");

                    b.HasOne("eTeamProjectManagement.Entities.ProjectUpdateTypes", "UpdateType")
                        .WithMany()
